...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (preg_match('#^/admin/(?P<id>[^/]++)/adresses$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/admin/(?P<id>[^/]++)/factures$#s', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/admin/c')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/commandes')) {
                        ...
                        if (rtrim($pathinfo, '/') === '/admin/commandes') {
                            ...
                            return array (  '_controller' => 'Ecommerce\\EcommerceBundle\\Controller\\CommandesAdminController::commandesAction',  '_route' => 'adminCommandes',);
                        }
